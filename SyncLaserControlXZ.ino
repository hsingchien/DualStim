...
void loop()
{
  ...
  case 3:
    ...
    if (LaserChannel1 == 4)
    {
      ...
      pinOutLaser1 = pin473Laser1;
      portforLaser1 = &PORTD;
    }
    else if (LaserChannel1 == 12)
    {
      pinOutLED1 = pin473LED2;
      pinOutLaser1 = pin473Laser2;
      portforLaser1 = &PORTB;
    }
    else
    {
    ...
    if (LaserChannel2 == 4)
    {
      pinOutLED2 = pin473LED1;
      pinOutLaser2 = pin473Laser1;
      portforLaser2 = &PORTD;
    }
    else if (LaserChannel2 == 12)
    {
      pinOutLED2 = pin473LED2;
      pinOutLaser2 = pin473Laser2;
      portforLaser2 = &PORTB;
    }
    else
    {
